    ...
    <div style="margin: auto; margin-top: 10vh">
        ...
        <div>
            <div>
                ...
                <h2 name="choice" v-for="ch in this.question.qsub" :key="ch.option" class="input" id="radio" >
                    {{ch.option}}&nbsp; :&nbsp;&nbsp; _____________ </h2>
...
export default {
    ...
    methods:{
        save(key){
            ...
            this.$firestore.surveys.doc(key).update({qid:this.question.qid,qname:this.question.qname,type:"qexpend",
